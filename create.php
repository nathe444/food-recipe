...
$sql = "INSERT INTO users (firstname, lastname, username, email, password) VALUES ('natnael', 'mulugeta', 'nati', 'n@gmail.com', '123')";
if ($conn->query($sql) === TRUE) {
  echo "user successfully added <br>";
} else {
  echo "Error adding a user: " . $conn->error;
}
